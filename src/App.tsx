...
function App() {
  ...
  return (
    <>
      <main className="flex h-full w-screen flex-col bg-[url(light_background.png)] bg-cover px-8 py-12 dark:bg-gray-800 dark:bg-[url(dark_background.png)] sm:h-screen sm:px-12 md:flex-row md:px-20">
